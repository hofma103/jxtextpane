...
/**
 * Lacking class in swingX. Inspired from JTextPane implementation (in Swing)
 * rlateed to JEditorPane. Add Undo/Redo and search features.
 *
...
public class JXTextPane extends JXEditorPane {
	...
	/**
	 * To turn around ugly overloading of paste() in JXEditorPane ... (intended
	 * to handle html style, which is not our subject)
	 */
	@Override
	public void paste() {
	...
	public void setText(final String t) {
		// getDocument().removeUndoableEditListener(getUndoableEditListener());//
		// pour debrayer lengthregistre undo/redo
		super.setText(t);
	 ...
	 * make this static? JW: these if-constructs are totally crazy ... we live
	 * in OO world!
	 *
	 */
