 ...
 * JXTextPane for easy replacement of former JXTextPane
 * 
...
public class LineNumbersTextPane extends JXTextPane {
	...
	public Rectangle modelToScrollView(int pos) throws BadLocationException {
		...
		offset.translate(-jScrollPane1.getViewport().getViewPosition().x,
	...
	public class LineNumbersSidePane extends JPanel {
		...
		public void paint(Graphics g) {
			...
			try {
				starting_y = _editor.modelToView(viewStart).y - jScrollPane1.getViewport().getViewPosition().y
						+ fontHeight - fontDesc;
