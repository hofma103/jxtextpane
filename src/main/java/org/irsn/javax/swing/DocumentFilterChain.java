...
/**
 * Class intended to allow multiple DocumentFilter in one Document. Be carefull
 * with order of filters. May be not reversible. For instance BlockModeHandler
 * should be declared as last argument of DocumentFilterChain
 * 
 * @author richet
 */
