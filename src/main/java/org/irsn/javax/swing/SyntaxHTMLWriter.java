...
/**
 * Class to add more complete HTML rendering than just bold, italic and
 * underline. Following StyleConstants are supported: Foreground, Backgournd,
 * FontSize, FontFamiliy
 * 
 * @author richet
 */
public class SyntaxHTMLWriter extends AbstractWriter {
	...
	protected void writeStartParagraph(Element elem) throws IOException {
		/*
		 * AttributeSet attr = elem.getAttributes(); Object resolveAttr =
		 * attr.getAttribute(StyleConstants.ResolveAttribute); /*if (resolveAttr
		 * instanceof StyleContext.NamedStyle) { writeStartTag("<p class=" +
		 * mapStyleName(((StyleContext.NamedStyle) resolveAttr).getName()) +
		 * ">"); } else { writeStartTag("<p>"); }
		 */
	}
